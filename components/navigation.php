<div class="d-flex" id="wrapper">
    ...
    <div class="border-right" id="sidebar-wrapper">
      <div class="sidebar-heading text-dark"><img src="assets/images/appname.svg" style="height:40px;width:40px"> Admin System</div>
      <div class="list-group list-group-flush">
        <a href="dashboard.php" class="list-group-item list-group-item-action bg-dark text-white">Dashboard</a>
        <a href="donor.php" class="list-group-item list-group-item-action bg-light ">Donor</a>
        ...
        <a href="donation_box.php" class="list-group-item list-group-item-action bg-dark text-white">Donation_Box</a>
